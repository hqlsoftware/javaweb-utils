package com.heqilin.util.plugin.ueditor.hunter;
...
import com.heqilin.util.plugin.ueditor.define.MultiState;
...
public class FileManager {
	...
	public State listFile ( int index ) {
		...
		if(OssClientProperties.useStatus){
			...
			String prefix = this.dir.replace(SystemUtil.getProjectPath(), "");
