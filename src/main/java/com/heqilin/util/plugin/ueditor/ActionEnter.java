...
import com.heqilin.util.plugin.ueditor.hunter.FileManager;
import com.heqilin.util.plugin.ueditor.hunter.ImageHunter;
import com.heqilin.util.plugin.ueditor.upload.Uploader;
...
public class ActionEnter {
     ...
     * @return
     */
    public Map<String, Object> getUEditorConf(String action) {
        ...
        if(conf==null){
            LogUtil.error("action目前只支持 uploadimage/uploadscrawl/uploadvideo/uploadfile/catchimage/listfile/listimage");
        }
