 ...
 * date:  2019/03/07
 */
public class MemcachedSerializingTranscoder extends BaseSerializingTranscoder implements
        Transcoder<Object> {
    // General flags
     ...
     */
    public MemcachedSerializingTranscoder() {
     ...
     */
    public MemcachedSerializingTranscoder(int max) {
        super(max);
    }
